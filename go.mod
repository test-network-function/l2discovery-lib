...
replace github.com/test-network-function/l2discovery/l2lib/pkg/export => github.com/edcdavid/l2discovery/l2lib/pkg/export v1.0.0

replace github.com/test-network-function/l2discovery/l2lib => github.com/edcdavid/l2discovery/l2lib v1.0.0
